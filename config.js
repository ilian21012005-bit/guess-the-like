...
module.exports = {
  ...
  // Playwright / preload
  PLAYWRIGHT_CONCURRENT: envInt('PLAYWRIGHT_CONCURRENT', 1),
  SERVER_PRELOAD_WORKERS: envInt('SERVER_PRELOAD_WORKERS', 1),
  SERVER_PRELOAD_VIDEO_TIMEOUT_MS: envInt('SERVER_PRELOAD_VIDEO_TIMEOUT_MS', 120000),
  PRELOAD_DELAY_BETWEEN_MS: envInt('PRELOAD_DELAY_BETWEEN_MS', 2500),
  PRELOAD_MIN_BEFORE_START: envInt('PRELOAD_MIN_BEFORE_START', 10),
